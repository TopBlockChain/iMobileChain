...
// along with the go-ethereum library. If not, see <http://www.gnu.org/licenses/>.package params
...
// 	PrevTime string
// 	CurrentTime string
// 	MinerCandidates string
//     MobileMiners string
// }
// var Unconfirmed_block map[uint64]RegistryBlock
