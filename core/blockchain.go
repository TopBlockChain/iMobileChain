...
func (bc *BlockChain) WriteBlockWithState(block *types.Block, receipts []*types.Receipt, state *state.StateDB) (status WriteStatus, err error) {
	...
	// content:="num:"+block.Number().String()+"blockhash:"+block.Hash().String()+"root:"+block.Header().Root.String()+"\r\n"
    // //fmt.Println("num:"+block.Number().String()+"blockhash:"+block.Hash().String()+"root:"+block.Header().Root.String()+"\r\n")
    ...
    //    fmt.Println("写入文件成功",block.NumberU64())
    //}    
